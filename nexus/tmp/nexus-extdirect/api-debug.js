...
NX.direct.api.REMOTING_API = {
  ...
  actions: {
    ...
    coreui_Datastore: [
      ...
      {
        name: 'update'/*(org.sonatype.nexus.coreui.DataStoreXO) => org.sonatype.nexus.coreui.DataStoreXO */,
        len: 1,
        formHandler: false
      },
      {
        name: 'create'/*(org.sonatype.nexus.coreui.DataStoreXO) => org.sonatype.nexus.coreui.DataStoreXO */,
        len: 1,
        formHandler: false
      },
      {
